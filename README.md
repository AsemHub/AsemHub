...
| **promptfoo upstream fixes** — [#9977](https://github.com/promptfoo/promptfoo/issues/9977), [#9978](https://github.com/promptfoo/promptfoo/issues/9978) | Found and reported two scoring bugs in the context-faithfulness grader of promptfoo (OpenAI-owned LLM eval framework, ~25k stars): the grader silently scored the wrong context while its metadata claimed otherwise, and statements with no verdict counted as supported. Both confirmed by a contributor and fixed upstream within a week ([PR #9994](https://github.com/promptfoo/promptfoo/pull/9994), [PR #9984](https://github.com/promptfoo/promptfoo/pull/9984)); the #9977 fix followed my triage recommendation, and a follow-on PR generalized it to every model-graded matcher. | promptfoo internals, TypeScript |
